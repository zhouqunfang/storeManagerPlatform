  ...
  <div class="front-container">
    ...
    <div style="display: flex; grid-gap: 20px; margin-bottom: 10px">
      <div style="flex: 1">
        <el-carousel height="450px">
          <el-carousel-item v-for="item in data.carouselList" :key="item.id">
            <img
              @click="router.push('/front/goodsDetail?id=' + item.goodsId)"
              :src="item.img"
              alt=""
      ...
      <div class="card" style="width: 260px">
        ...
        >
          ...
          <div style="color: red; font-weight: bold; font-size: 20px; margin-left: 2px">
            为您推荐
          </div>
        </div>
        <div style="padding: 20px 0">
          <div
            ...
            style="cursor: pointer; display: flex; grid-gap: 10px; margin-bottom: 20px"
    ...
    <div class="card" style="padding: 20px">
      ...
      >
        ...
        <div @click="router.push('/front/goods')" style="cursor: pointer; font-size: 13px">
          查看更多
        </div>
      </div>
        ...
        <el-row :gutter="20">
          <el-col :span="6" v-for="item in data.hotGoods" :key="item.id">
            <div
              @click="router.push('/front/goodsDetail?id=' + item.id)"
              class="item"
              style="width: 100%; border-radius: 5px; height: 350px"
            >
              <img
                :src="item.img"
                alt=""
                style="width: 100%; height: 260px; border-radius: 5px 5px 0 0"
              />
